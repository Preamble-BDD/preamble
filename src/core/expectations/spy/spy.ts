// // let argsToArray = require("./helpers.js").argsToArray,
// //     a_equals_b = require("./expectations/assertions.js").a_equals_b;
//
// interface ISnoopster {
//     (...args): any;
// }
//
// interface ISpyOn {
...
//             let a = argsToArray(arguments);
//             return calls.some(function(call) {
//                 let args = call.getArgs().args;
